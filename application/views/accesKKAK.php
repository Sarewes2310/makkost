<html>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function(){
        ...
        $('#MAccesRejected').on('show.bs.modal',function (event) {
          ...
          $('#IDACdeleteAccess').val(idak);
        });
        $('#mintaAccessModal').on('show.bs.modal',function (event) {
          $.ajax({
            url:"<?php echo base_url('index.php/AKController/DataMintaKKRK')?>",
            type:"post",
            dataType:"json",
            success:function(result){
              $('#isiMintaAccess').html(result);
              $('#ListRumKost').change(function(){
                $.ajax({
                  url:"<?php echo base_url('index.php/AKController/DataMintaKK')?>",
                  type:"post",
                  data:"data="+JSON.stringify($('#ListRumKost').val()),
                  dataType:"json",
                  success:function(result){
                    $('#isiMintaAccess').append(result);
                    dat['RK'] = $('#ListRumKost :selected').val();
                    $('#ListKamKost').change(function(){
  ...
  <body>
    ...
    <div>
      ...
      <a id="MintaAccessButton" href="#" class="button button-circle button-flat-royal" data-toggle="modal" data-target="#mintaAccessModal"><span class="oi oi-plus"></span></a>
    ...
    <div class="modal fade" id="MAccesRejected" tabindex="-1" role="dialog" aria-labelledby="">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form method="post" id="deleteAccessTeman" action="#" onsubmit="return deleteAccessTeman()">
          <div class="modal-body">
              <p>Apakah anda yakin menghapus <b id="nameRejected"></b> ?</p>
          </div>
          <div class="modal-footer">
            <input type="text" id="IDACdeleteAccess"/>
            <button type="submit" class="btn btn-primary">Ya</button>
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak</button>
          </div>
        </form>
    ...
    <div class="modal fade" id="mintaAccessModal" tabindex="-1" role="dialog" aria-labelledby="">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title"><b>Access Kamar</b></h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <form method="post" id="mintaAccess" action="#" onsubmit="return mintaAccess()">
            <div class="modal-body">
              <div id="isiMintaAccess"></div>
            </div>
            <div class="modal-footer">
              <button type="submit" class="btn btn-primary">Ya</button>
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak</button>
